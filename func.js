...
var btns = header.getElementsByClassName("btn-primary");
...
function isTimeBeforeCurrentTime(hour, minute) {
    const currentTime = new Date();
    const selectedDate = new Date(hour, minute);
    return selectedDate < currentTime;
}
function activateButton(button) {
    
    let buttons = document.getElementsByClassName("timebtn");
