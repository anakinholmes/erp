                        ...
                        <label for="" class="col-md-8 col-sm-5 col-form-label" id="em" >Цагийн мэдээлэл</label>
                           ...
                           Огноо</label>
                            ...
                            <div class="symptomsOnset">
                                <label for="" class="col-md-12 col-sm-5 col-form-label">Үргэлжилсэн хугацаа</label>
                                <input class="symon" type="text">
                            </div>
                            <button class="btn btn-primary savebtn " onclick="">Хадгалах</button>
                        </div>
                    </div>
                </div>
            </div>
